...
public:
	konamigx_state(const machine_config &mconfig, device_type type, const char *tag)
		...
		, m_k054539(*this, "k054539_%u", 1U)
		, m_k053250(*this, "k053250_%u", 1U)
		...
		, m_main_paletteram_32(*this, "paletteram")
		, m_an0(*this, "AN0")
		, m_an1(*this, "AN1")
...
protected:
	...
	optional_device_array<k054539_device, 2> m_k054539;
	optional_device_array<k053250_device, 2> m_k053250;
	...
	optional_shared_ptr<u32> m_main_paletteram_32;
	...
	u8 m_opri = 0, m_oinprion = 0;
	u8 m_vcblk[6]{}, m_ocblk = 0;
	u8 m_vinmix = 0, m_vmixon = 0, m_osinmix = 0, m_osmixon = 0;
