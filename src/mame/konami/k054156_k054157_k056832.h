...
public:
	...
	// bpp (see above), big gfx size, layer association hack
...
private:
	...
	u32       m_num_gfx_banks; // depends on size of graphics ROMs
	u32       m_cur_gfx_banks; // cached info for K056832_regs[0x1a]
