...
{
	pgm_basic_mem(map);
	map(0x300000, 0x303fff).mirror(0x0fc000).ram().share("igs022:sharedprotram"); // Shared with protection device
}
...
{
	pgmbase(config);
	m_maincpu->set_addrmap(AS_PROGRAM, &pgm_022_025_state::pgm_022_025_mem);
