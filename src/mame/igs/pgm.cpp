...
{
	LOGSOUND("Z80: ctrl %04x @ %04x (%06x)\n", data, mem_mask, m_maincpu->pc());
}

void pgm_state::m68k_l1_w(u8 data)
{
	LOGSOUND("SL 1 m68.w %02x (%06x) IRQ\n", data, m_maincpu->pc());
...
void pgm_state::pgm_base_mem(address_map &map)
{
	...
	map(0xb00000, 0xb0ffff).mirror(0x0f0000).ram().share("videoregs");
	map(0xb00000, 0xb00fff).mirror(0x0f0000).readonly().share(m_spritebuffer);
	map(0xb01000, 0xb0103f).mirror(0x0f0fc0).writeonly().share(m_zoomtable);
	map(0xb02000, 0xb02001).mirror(0x0f0ffe).ram().share(m_bg_yscroll);
	map(0xb03000, 0xb03001).mirror(0x0f0ffe).ram().share(m_bg_xscroll);
	map(0xb04000, 0xb04001).mirror(0x0f0ffe).ram().share(m_videoreg_4000);
	map(0xb05000, 0xb05001).mirror(0x0f0ffe).ram().share(m_tx_yscroll);
	map(0xb06000, 0xb06001).mirror(0x0f0ffe).ram().share(m_tx_xscroll);
	map(0xb0e000, 0xb0e001).mirror(0x0f0ffe).ram().share(m_videoreg_e000);

	map(0xc00003, 0xc00003).mirror(0x07fff0).r(m_soundlatch, FUNC(generic_latch_8_device::read)).w(FUNC(pgm_state::m68k_l1_w));
	map(0xc00005, 0xc00005).mirror(0x07fff0).rw("soundlatch2", FUNC(generic_latch_8_device::read), FUNC(generic_latch_8_device::write));
	map(0xc00007, 0xc00007).mirror(0x07fff0).rw("rtc", FUNC(v3021_device::read), FUNC(v3021_device::write));
	map(0xc00008, 0xc00009).mirror(0x07fff0).w(FUNC(pgm_state::z80_reset_w));
	map(0xc0000a, 0xc0000b).mirror(0x07fff0).w(FUNC(pgm_state::z80_ctrl_w));
	map(0xc0000d, 0xc0000d).mirror(0x07fff0).rw(m_soundlatch3, FUNC(generic_latch_8_device::read), FUNC(generic_latch_8_device::write));

	map(0xc08000, 0xc08001).mirror(0x07fff8).portr("P1P2");
	map(0xc08002, 0xc08003).mirror(0x07fff8).portr("P3P4");
	map(0xc08004, 0xc08005).mirror(0x07fff8).portr("Service");
	map(0xc08006, 0xc08007).mirror(0x07fff8).portr("DSW").w(FUNC(pgm_state::coin_counter_w));
...
// for mirrored ROM loading

#define ROM_LOAD16_WORD_SWAP_X2(name, offset, length, hash) \
        ROM_LOAD16_WORD_SWAP(name, offset,  length, hash) \
        ROM_RELOAD(                offset + length, length)

#define ROM_LOAD16_WORD_SWAP_X8(name, offset, length, hash) \
        ROM_LOAD16_WORD_SWAP(name, offset,   length, hash) \
        ROM_RELOAD(                offset +  length,      length) \
        ROM_RELOAD(                offset + (length * 2), length) \
        ROM_RELOAD(                offset + (length * 3), length) \
        ROM_RELOAD(                offset + (length * 4), length) \
        ROM_RELOAD(                offset + (length * 5), length) \
        ROM_RELOAD(                offset + (length * 6), length) \
        ROM_RELOAD(                offset + (length * 7), length)
...
ROM_START( drgw2 )
	ROM_REGION( 0x600000, "maincpu", 0 ) // 68000 Code
	PGM_68K_BIOS
	ROM_LOAD16_WORD_SWAP_X2( "dragon_ii_v-110x.u2",    0x100000, 0x080000, CRC(1978106b) SHA1(af8a13d7783b755a58762c98bdc32cab845b2251) )
...
ROM_START( drgw2100x )
	ROM_REGION( 0x600000, "maincpu", 0 ) // 68000 Code
	PGM_68K_BIOS
	ROM_LOAD16_WORD_SWAP_X2( "dragon_ii_v-100x.u2",    0x100000, 0x080000,  CRC(5e71851d) SHA1(62052469f69daec88efd26652c1b893d6f981912) )
...
ROM_START( drgw2101c )
	ROM_REGION( 0x600000, "maincpu", 0 ) // 68000 Code
	PGM_68K_BIOS
	ROM_LOAD16_WORD_SWAP_X2( "dragon_ii_v-101c.u2",    0x100000, 0x080000, CRC(b0c592fa) SHA1(87ccfdb940303ebcf42cb2952aecae97648c1e0d) )
...
ROM_START( drgw2100c )
	ROM_REGION( 0x600000, "maincpu", 0 ) // 68000 Code
	PGM_68K_BIOS
	ROM_LOAD16_WORD_SWAP_X2( "dragon_ii_v-100c.u2",    0x100000, 0x080000, CRC(67467981) SHA1(58af01a3871b6179fe42ff471cc39a2161940043) )
...
ROM_START( drgw2100j )
	ROM_REGION( 0x600000, "maincpu", 0 ) // 68000 Code
	PGM_68K_BIOS
	ROM_LOAD16_WORD_SWAP_X2( "dragon_ii_v100j.u2",    0x100000, 0x080000, CRC(f8f8393e) SHA1(ef0db668b4e4f661d4c1e95d57afe881bcdf13cc) )
...
ROM_START( drgw2100hk ) // the IGS025 has a "DRAGON-II 0004-1" sticker, the IGS012 has no per-game marking
	ROM_REGION( 0x600000, "maincpu", 0 ) // 68000 Code
	PGM_68K_BIOS
	ROM_LOAD16_WORD_SWAP_X2( "dragon_ii_v-100-h.u2",    0x100000, 0x080000, CRC(c6e2e6ec) SHA1(84145dfb26857ea20efb233363f175bc9bb25b0c) )
...
ROM_START( kov2 )
	...
	ROM_REGION32_LE( 0x400000, "prot_data", 0 ) /* Protection Data (encrypted external ARM data) */
...
ROM_START( dw2001 )
	...
	ROM_REGION32_LE( 0x4000000, "prot_data", ROMREGION_ERASEFF )
...
ROM_START( dmnfrnt ) // same romset has also been found on a single PCB board (set dmnfrnta in FBNeo)
	...
	ROM_REGION32_LE( 0x800000, "prot_data", 0 ) /* Protection Data (encrypted external ARM data, internal missing) */
...
ROM_START( dmnfrntpcb )
	ROM_REGION( 0x600000, "maincpu", 0 ) // 68000 Code
	ROM_LOAD16_WORD_SWAP_X8( "pgm_p02s.u42",                 0x000000, 0x020000, CRC(78c15fa2) SHA1(885a6558e022602cc6f482ac9667ba9f61e75092) ) /* IGS PGM P02S 1A3708A1A0 S002838  (uses standard PGM v2 bios) */
...
ROM_START( oldsplus )
	...
	ROM_REGION32_LE( 0x800000, "prot_data", ROMREGION_ERASE00 )
...
//  ROM_LOAD( "killbldp_igs027a.bin", 0x000000, 0x04000, CRC(c7868d90) SHA1(335c99933a38b77fcfc3f8004063f35124364f3e) ) // this is the original rom with the first 0x268 bytes from the bootleg - but it doesn't work?
	...
	ROM_REGION32_LE( 0x800000, "prot_data", 0 ) /* Protection Data (encrypted external ARM data) */
...
ROM_START( happy6 )
	...
	ROM_REGION( 0x600000, "maincpu", 0 ) // 68000 Code
	PGM_68K_BIOS
	ROM_LOAD16_WORD_SWAP_X8( "s101xx_u5.u5",      0x100000, 0x080000, CRC(aa4646e3) SHA1(e6772cc480ddd3e1d199364b1f2ff93b973e6842) ) // V101 03/17/04 11:26:48
...
ROM_START( happy6101 )
	...
	ROM_REGION( 0x600000, "maincpu", 0 ) // 68000 Code
	PGM_68K_BIOS
	ROM_LOAD16_WORD_SWAP_X8( "v100cn_u5.u5",      0x100000, 0x080000, CRC(a25418e8) SHA1(acd7e7b69956cb4ce8e26c6420cb97bb4bf404e7) ) // V100 12/22/03 15:35:33
...
ROM_START( happy6100hk )
	...
	ROM_REGION( 0x600000, "maincpu", 0 ) // 68000 Code
	PGM_68K_BIOS
	ROM_LOAD16_WORD_SWAP_X8( "v100hk_u5.u5",      0x100000, 0x080000, CRC(a25418e8) SHA1(acd7e7b69956cb4ce8e26c6420cb97bb4bf404e7) ) // V100 12/22/03 15:35:33
...
ROM_START( ketbl ) // this assumes a Dodonpachi 2 Bee Storm cart was used
	...
	ROM_REGION32_LE( 0x400000, "prot_data", 0 ) /* Protection Data (encrypted external ARM data) */ // leftover from original game
...
ROM_START( ddp3 )
	ROM_REGION( 0x600000, "maincpu", 0 ) // 68000 Code
	ROM_LOAD16_WORD_SWAP_X2( "ddp3_bios.u37",      0x000000, 0x080000, CRC(b3cc5c8f) SHA1(02d9511cf71e4a0d6ca8fd9a1ef2c79b0d001824) ) // uses a standard PGM bios with the startup logos hacked out
...
ROM_START( ddpdojp )
	ROM_REGION( 0x600000, "maincpu", 0 ) // 68000 Code
	ROM_LOAD16_WORD_SWAP_X8( "pgmbios.u20.27c210",         0x000000, 0x020000, CRC(1d2a7c15) SHA1(025a9f2bb64887699bf7ccab0f2ccfc55c3ad75c) )
