...
void enveEmuResetOperator(jkm8580Operator* pVoice)
{
	/* mute, end of R-phase */
...
static inline uint16_t enveEmuStartAttack(jkm8580Operator*);
static inline uint16_t enveEmuStartDecay(jkm8580Operator*);
static inline uint16_t enveEmuStartRelease(jkm8580Operator*);
static inline uint16_t enveEmuAlterAttack(jkm8580Operator*);
static inline uint16_t enveEmuAlterDecay(jkm8580Operator*);
static inline uint16_t enveEmuAlterSustain(jkm8580Operator*);
static inline uint16_t enveEmuAlterSustainDecay(jkm8580Operator*);
static inline uint16_t enveEmuAlterRelease(jkm8580Operator*);
static inline uint16_t enveEmuAttack(jkm8580Operator*);
static inline uint16_t enveEmuDecay(jkm8580Operator*);
static inline uint16_t enveEmuSustain(jkm8580Operator*);
static inline uint16_t enveEmuSustainDecay(jkm8580Operator*);
static inline uint16_t enveEmuRelease(jkm8580Operator*);
static inline uint16_t enveEmuMute(jkm8580Operator*);

static inline uint16_t enveEmuStartShortAttack(jkm8580Operator*);
static inline uint16_t enveEmuAlterShortAttack(jkm8580Operator*);
static inline uint16_t enveEmuShortAttack(jkm8580Operator*);
...
static inline void enveEmuEnveAdvance(jkm8580Operator* pVoice)
{
#ifdef SID_FPUENVE
...
static inline uint16_t enveEmuMute(jkm8580Operator* pVoice)
{
	return 0;
}
...
static inline uint16_t enveEmuRelease(jkm8580Operator* pVoice)
{
#ifdef SID_FPUENVE
...
static inline uint16_t enveEmuAlterRelease(jkm8580Operator* pVoice)
{
...
static inline uint16_t enveEmuStartRelease(jkm8580Operator* pVoice)
{
...
static inline uint16_t enveEmuSustain(jkm8580Operator* pVoice)
{
	return masterAmplModTable[pVoice->masterVolumeAmplIndex+pVoice->enveVol];
}

static inline uint16_t enveEmuSustainDecay(jkm8580Operator* pVoice)
{
#ifdef SID_FPUENVE
	pVoice->enveStep = (uint16_t)pVoice->fenveStep;
#endif
...
static inline uint16_t enveEmuAlterSustainDecay(jkm8580Operator* pVoice)
{
...
static inline uint16_t enveEmuAlterSustain(jkm8580Operator* pVoice)
{
	if (pVoice->enveVol > pVoice->enveSusVol)
	{
...
static inline uint16_t enveEmuDecay(jkm8580Operator* pVoice)
{
#ifdef SID_FPUENVE
	pVoice->enveStep = (uint16_t)pVoice->fenveStep;
#endif
...
static inline uint16_t enveEmuAlterDecay(jkm8580Operator* pVoice)
{
	uint8_t decay = pVoice->SIDAD & 0x0F ;
#ifdef SID_FPUENVE
	pVoice->fenveStepAdd = decayReleaseRates[decay];
...
static inline uint16_t enveEmuStartDecay(jkm8580Operator* pVoice)
{
...
static inline uint16_t enveEmuAttack(jkm8580Operator* pVoice)
{
#ifdef SID_FPUENVE
	pVoice->enveStep = (uint16_t)pVoice->fenveStep;
#endif
...
static inline uint16_t enveEmuAlterAttack(jkm8580Operator* pVoice)
{
...
static inline uint16_t enveEmuStartAttack(jkm8580Operator* pVoice)
{
...
static inline uint16_t enveEmuShortAttack(jkm8580Operator* pVoice)
{
#ifdef SID_FPUENVE
	pVoice->enveStep = (uint16_t)pVoice->fenveStep;
#endif
...
static inline uint16_t enveEmuAlterShortAttack(jkm8580Operator* pVoice)
{
	uint8_t attack = pVoice->SIDAD >> 4;
#ifdef SID_FPUENVE
	pVoice->fenveStepAdd = attackRates[attack];
...
static inline uint16_t enveEmuStartShortAttack(jkm8580Operator* pVoice)
{
